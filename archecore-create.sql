...
spid_fk INT UNSIGNED NOT NULL,
bidder_fk CHAR(36) DEFAULT NULL,
bpid_fk INT UNSIGNED DEFAULT NULL,
bid_id INT,
timeout INT,
buyout INT,
auct_state INT,
...
LANGUAGE SQL
DETERMINISTIC
COMMENT 'Populates all the nessesary tables with information relevant to a new persona'
BEGIN
	DECLARE pers_id INT UNSIGNED;
	DECLARE done INT DEFAULT FALSE;
	DECLARE skill_name VARCHAR(255);
